...
const AccountSettingsModal: React.FC<AccountSettingsModalProps> = ({ account, onClose, onSave }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-4">
      <div className="bg-white dark:bg-slate-800 rounded-lg max-w-md w-full shadow-2xl animate-fade-in">
        ...
        <div className="p-6 space-y-4">
          <div>
            <label className="text-sm font-medium text-slate-600 dark:text-slate-300" htmlFor="account-name">Display Name</label>
            <input
              id="account-name"
              name="name"
              value={formData.name}
           ...
           <div>
            <label className="text-sm font-medium text-slate-600 dark:text-slate-300" htmlFor="account-email">Primary Email</label>
            <input
              id="account-email"
              type="email"
              value={account.email}
              disabled
              className="mt-1 w-full px-3 py-2 border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-900/50 rounded-md text-slate-500 dark:text-slate-400 cursor-not-allowed"
            />
          </div>
          <div>
            <label className="text-sm font-medium text-slate-600 dark:text-slate-300" htmlFor="recovery-email">Recovery Email</label>
            <input
              id="recovery-email"
              name="recoveryEmail"
              type="email"
          ...
          <div>
            <label className="text-sm font-medium text-slate-600 dark:text-slate-300" htmlFor="recovery-phone">Recovery Phone</label>
            <input
              id="recovery-phone"
              name="recoveryPhone"
              type="tel"
